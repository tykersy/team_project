                    ...
                    <div class="panel">
                        ...
                        <div class="calendar-list" style="margin-top: 15px;">
                            ...
                            <c:if test="${empty scheduleList}">
                                <p style="color: #94a3b8; text-align: center; margin-top: 30px; font-size: 0.95rem;">📢 예정된 부서 일정이 없습니다.</p>
                            </c:if>
                        </div>
                    </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="notice-list">
                            ...
                            <c:if test="${empty boardList}">
                                <p style="color: #999; text-align: center; margin-top: 20px;">등록된 공지사항이 없습니다.</p>
                            </c:if>
                        </div>
                    </div>
