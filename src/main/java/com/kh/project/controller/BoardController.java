    ...
    public Map<String, String> processAi(@RequestBody Map<String, String> params) {
        ...
        switch (type) {
            ...
            case "translate":
                ...
                6. 번역 시 원문에 없는 기호(괄호 등)를 임의로 추가하거나 변형하지 마십시오. 원문의 형식을 그대로 유지하십시오
                [번역할 내용]
                %s
