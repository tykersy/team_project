...
public class BoardController {
    ...
    public Map<String, String> processAi(@RequestBody Map<String, String> params) {
        ...
        switch (type) {
            ...
            [엄격한 제약 사항]
            1. 요약 결과는 오직 한국어(한글)만 사용하고 한자(Chinese characters)는 절대 사용하지 말 것.
            2. 입력된 본문에 포함된 외국어(영어, 일본어, 중국어, 한자 등)는 절대 출력하지 마십시오.
            3. 번역이 불가능하다면 해당 단어를 제거하십시오.
            4. 특수문자나 기호 사용을 지양하고, 온점(.)을 사용하여 문장을 마무리하십시오.
            5. 핵심 내용 위주로 3~4개의 문장으로 작성하고, 문장 끝마다 줄바꿈을 적용하되 빈 줄(공백 라인)은 넣지 마십시오.
